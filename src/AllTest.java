...
public class AllTest {
	...
	public void sameCGPA() throws FileNotFoundException {
		...
		List<String> resultado= Solution.printStudents(studentList);
...
public void sameCGPAName() throws FileNotFoundException {
		...
		List<Student> studentList = new ArrayList<Student>();
		String   fileName = "C:\\Users\\Calde\\Desktop\\QAhomework\\src\\Test3.txt";
		File test3  = new File(fileName);		
